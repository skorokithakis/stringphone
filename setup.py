...
#
#     from stringphone import metadata
#
# However, when we do this, we also import `stringphone/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'stringphone_cli = stringphone.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'stringphone_gui = stringphone.gui:entry_point'
        # ]
    }
)
